...
export default function Sidebar({
  ...
  return (
    <>
      <aside className="flex flex-col h-full sm:w-80 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border-r border-zinc-200 dark:border-zinc-800  p-6 gap-4 transition-colors duration-300 md:static md:translate-x-0 md:shadow-none">
        {/* Logo / App Name */}
      ...
      {showAddList && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <form
            ...
            className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-6 w-full max-w-xs flex flex-col gap-5 border border-zinc-100 dark:border-zinc-800 animate-fade-in"
            style={{ minWidth: 320 }}
          >
            <button
              type="button"
